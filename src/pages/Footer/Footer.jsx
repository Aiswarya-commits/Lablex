...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        {/* Company Info */}
        <div style={{ flex: "1 1 300px" ,marginLeft:"150px"}}>
          <h2 style={{ color: "#FF6F3C", fontSize: "26px", marginBottom: "10px" }}>
            LABELEX
          </h2>
          <p style={{ fontWeight: "bold", color: "#00BCD4", marginBottom: "10px" }}>
            SELF ADHESIVE LABELS MANUFACTURING LLC
          </p>
          <p style={{ marginBottom: "10px" }}>
            Warehouse No: 14, Industrial Zone 1, Jurf<br />
            Ajman, United Arab Emirates
          </p>
          <p style={{ marginBottom: "10px" }}>
            Tel: <a href="tel:+97165205240" style={{ color: "#ccc" }}>+971 6 5205240</a><br />
            Mob: <a href="tel:0565405252" style={{ color: "#ccc" }}>0565405252</a>
          </p>
          <p style={{ marginBottom: "10px" }}>
            TRN: <strong>104780815700003</strong>
          </p>
          <p>Email: <a href="mailto:info@labelex.com" style={{ color: "#ccc" }}>info@labelex.com</a></p>
        </div>

        {/* Quick Links */}
        <div style={{ flex: "1 1 200px" }}>
          <h3 style={{ color: "#FF6F3C", marginBottom: "15px" }}>Quick Links</h3>
        ...
        {/* Services */}
        <div style={{ flex: "1 1 200px" }}>
          <h3 style={{ color: "#FF6F3C", marginBottom: "15px" }}>Our Services</h3>
          <ul style={{ listStyle: "none", padding: 0, lineHeight: "2" }}>
      ...
      >
        ...
        <div>
          ...
          <img src={instagram} alt="" style={{width:"60px"}}/>
          <img src={twitter} alt="" style={{width:"60px"}}/>
        </div>
      </div>
    </footer>
  );
